...
start() {
    $HADOOP_HOME/bin/hadoop-daemon.sh start @HADOOP_DAEMON@
}
stop() {
...
case "$1" in
  ...
  *)
  N=/etc/init.d/$NAME
  echo "Usage: $N {start|stop|restart|force-reload|status|force-stop|upgrade|format}" >&2
  exit 1
  ;;
esac
